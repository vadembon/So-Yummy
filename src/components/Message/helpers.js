...
const style = {
  ...
  backgroundColor: '#53545599',
};

export const showError = error => {
  const message = error instanceof Error ? error.message : error;
  toast(t => <Message variant="error" t={t} message={message} />, { style });
};
...
export const showMotivation = message => {
  toast(t => <Message variant="motivation" t={t} message={message} />, {
